...
export default function FinancialPulse({ financials, isPublic }: Props) {
  if (!isPublic) {
    return (
      <div
        className="font-ibm-mono text-[10px] tracking-[0.15em] text-[var(--color-text-secondary)] px-2 py-0.5 border border-[var(--color-border)] rounded-sm inline-flex items-center gap-1"
      >
